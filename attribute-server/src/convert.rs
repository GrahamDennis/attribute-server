...
use thiserror::Error;
use crate::convert::FieldError::FieldMissing;
...
pub trait TryFromProto<T>: Sized {
    ...
    fn try_from_proto_with(value: T, parent: &mut dyn FnMut() -> garde::Path) -> ConversionResult<Self>;
}
...
impl TryFromProto<grpc::GetEntityRequest> for EntityLocator {
    fn try_from_proto_with(value: grpc::GetEntityRequest, mut parent: &mut dyn FnMut() -> garde::Path) -> ConversionResult<Self> {
        use FieldError::*;
...
impl TryFromProto<grpc::EntityLocator> for EntityLocator {
    fn try_from_proto_with(value: grpc::EntityLocator, mut parent: &mut dyn FnMut() -> garde::Path) -> ConversionResult<Self> {
        use FieldError::*;
...
impl TryFromProto<grpc::entity_locator::Locator> for EntityLocator {
    fn try_from_proto_with(value: grpc::entity_locator::Locator, mut parent: &mut dyn FnMut() -> garde::Path) -> ConversionResult<Self> {
...
impl TryFromProto<String> for EntityId {
    fn try_from_proto_with(value: String, parent: &mut dyn FnMut() -> garde::Path) -> ConversionResult<Self> {
        use FieldError::*;
...
impl TryFromProto<grpc::QueryEntitiesRequest> for EntityQuery {
    fn try_from_proto_with(value: grpc::QueryEntitiesRequest, mut parent: &mut dyn FnMut() -> garde::Path) -> ConversionResult<Self> {
        Ok(EntityQuery {
            root: {
                let mut path = garde::util::nested_path!(parent, "root");
                let entity_query_node_proto = value.root.ok_or_else(|| FieldMissing.at_path(path()))?;
...
impl TryFromProto<grpc::EntityQueryNode> for EntityQueryNode {
    fn try_from_proto_with(value: grpc::EntityQueryNode, mut parent: &mut dyn FnMut() -> garde::Path) -> ConversionResult<Self> {
        let mut path = garde::util::nested_path!(parent, "query");

        let query_proto = value
            .query
            .ok_or_else(||FieldMissing.at_path(path()))?;
...
impl TryFromProto<grpc::entity_query_node::Query> for EntityQueryNode {
    fn try_from_proto_with(value: grpc::entity_query_node::Query, mut parent: &mut dyn FnMut() -> garde::Path) -> ConversionResult<Self> {
        ...
        Ok(match value {
            ...
            Query::And(and_query_node) => {
                ...
                EntityQueryNode::And(AndQueryNode::try_from_proto_with(and_query_node, &mut path)?)
            }
...
impl TryFromProto<grpc::AndQueryNode> for AndQueryNode {
    fn try_from_proto_with(value: grpc::AndQueryNode, mut parent: &mut dyn FnMut() -> garde::Path) -> ConversionResult<Self> {
...
impl TryFromProto<grpc::OrQueryNode> for OrQueryNode {
    fn try_from_proto_with(value: grpc::OrQueryNode, mut parent: &mut dyn FnMut() -> garde::Path) -> ConversionResult<Self> {
        let mut path = garde::util::nested_path!(parent, "clauses");
        Ok(OrQueryNode {
            clauses: Vec::try_from_proto_with(value.clauses, &mut path)?,
        })
...
impl TryFromProto<Vec<grpc::EntityQueryNode>> for Vec<EntityQueryNode> {
    fn try_from_proto_with(value: Vec<grpc::EntityQueryNode>, mut parent: &mut dyn FnMut() -> garde::Path) -> ConversionResult<Self> {
        value
            .into_iter()
            .enumerate()
...
impl TryFromProto<grpc::CreateAttributeTypeRequest> for AttributeType {
    fn try_from_proto_with(value: grpc::CreateAttributeTypeRequest, mut parent: &mut dyn FnMut() -> garde::Path) -> ConversionResult<Self> {
        use FieldError::*;
...
impl TryFromProto<grpc::AttributeType> for AttributeType {
    fn try_from_proto_with(value: grpc::AttributeType, mut parent: &mut dyn FnMut() -> garde::Path) -> ConversionResult<Self> {
        use FieldError::*;
...
impl TryFromProto<grpc::ValueType> for ValueType {
    fn try_from_proto_with(value: grpc::ValueType, parent: &mut dyn FnMut() -> garde::Path) -> ConversionResult<Self> {
        use FieldError::*;
...
impl TryFromProto<grpc::UpdateEntityRequest> for UpdateEntityRequest {
    fn try_from_proto_with(value: grpc::UpdateEntityRequest, mut parent: &mut dyn FnMut() -> garde::Path) -> ConversionResult<Self> {
        use FieldError::*;
        ...
        Ok(UpdateEntityRequest {
            entity_locator: {
                ...
                let entity_locator_proto = value.entity_locator.ok_or_else(|| FieldMissing.at_path(path()))?;
            ...
            attributes_to_update: {
                ...
                let result: Result<Vec<_>, _> = value.attributes_to_update.into_iter().enumerate()
                    .map(|(idx, attribute_to_update)| {
                        let mut attribute_to_update_path = garde::util::nested_path!(path, idx);
                        AttributeToUpdate::try_from_proto_with(attribute_to_update, &mut attribute_to_update_path)
                    })
                    .collect();
                result?
            },
...
impl TryFromProto<grpc::AttributeToUpdate> for AttributeToUpdate {
    fn try_from_proto_with(value: grpc::AttributeToUpdate, mut parent: &mut dyn FnMut() -> garde::Path) -> ConversionResult<Self> {
        use FieldError::*;
        ...
        Ok(AttributeToUpdate {
            ...
            value: {
                ...
                let nullable_attribute_value = value.attribute_value.ok_or_else(||FieldMissing.at_path(path()))?;
...
impl TryFromProto<grpc::NullableAttributeValue> for Option<AttributeValue> {
    fn try_from_proto_with(value: grpc::NullableAttributeValue, mut parent: &mut dyn FnMut() -> garde::Path) -> ConversionResult<Self> {
...
impl TryFromProto<grpc::AttributeValue> for AttributeValue {
    fn try_from_proto_with(value: grpc::AttributeValue, mut parent: &mut dyn FnMut() -> garde::Path) -> ConversionResult<Self> {
        use FieldError::*;
...
impl TryFromProto<grpc::attribute_value::AttributeValue> for AttributeValue {
    fn try_from_proto_with(value: grpc::attribute_value::AttributeValue, mut parent: &mut dyn FnMut() -> garde::Path) -> ConversionResult<Self> {
        ...
        Ok(match value {
            ...
            attribute_value::AttributeValue::EntityIdValue(external_entity_id) => {
                ...
                AttributeValue::EntityId(EntityId::try_from_proto_with(external_entity_id, &mut path)?)
            }
